...
# %%
def test_protein_abund_correction_matched():
    # Test with matched sample names and columns between peptide and protein DataFrames
...
# %%
def run_tests():
    test_prot_abund_correction_matched()
